...
CREATE SEQUENCE	IF NOT EXISTS AUTHOR_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE	IF NOT EXISTS MANGA_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE	IF NOT EXISTS CHAPTER_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE	IF NOT EXISTS COUNTRY_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE	IF NOT EXISTS GENRE_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE	IF NOT EXISTS HOSTING_WEBSITE_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE	IF NOT EXISTS LANGUAGE_SEQUENCE START WITH 1 INCREMENT BY 1;
